       ...
       <h1 class="text-lg pt-6">User Details</h1>
         ...
         <form wire:submit.prevent="submitForm">
            ...
            <div class="py-2 flex space-x-4">
                <input type="text" wire:model="firstName" value="{{ old('firstName', $this->firstName) }}"
                 name="firstName" id="firstName"
                 class="block border-0 border-b-2 border-bg-zinc-900 p-0 bg-zinc-700 w-40 sm:text-xs" >


                <input type="text"  wire:model="LastName" value="{{ old('LastName', $this->LastName) }}"
               ...
               <div>
                <label for="email"
                  ...
                  <input type="text" wire:model="email" value="{{ old('email', $this->email) }}"
                  name="email" id="email"
            ...
            <div class="py-2 flex space-x-4">
                <input type="text" wire:model="password" value="{{ old('Password', $this->password) }}"
